...
while True:
  ...
  elif ((Luminance >= 20)or (Luminance < 40) and (statusoflamp1=='on') and (statusoflamp2=='on')):
    presentluminancelevel = 50
  elif ((Luminance >= 20)or (Luminance < 40) and (statusoflamp1=='on') and (statusoflamp2=='off')):
    presentluminancelevel = 40 
  elif ((Luminance >= 20)or (Luminance < 40) and (statusoflamp1=='off') and (statusoflamp2=='on')):
    presentluminancelevel = 40
  elif ((Luminance >= 20)or (Luminance < 40) and (statusoflamp1=='off') and (statusoflamp2=='off')):
    presentluminancelevel = 30
