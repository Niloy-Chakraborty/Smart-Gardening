...
class iotcontrol:
        ...
        for i in range(TotalPlants):
          ...
          if (df3>5) and (i==0):
            ...
            # Execute the SQL UPDATE statement
              ...
              bot.send_message(chat_id=update.callback_query.message.chat.id, text="No Watering, watered just before 5 hours") 
    ...
    def addPlant(self,bot,update,New_Plant):
        conn.connect()
        insert_query = "INSERT INTO PlantDatabase(Plant_Name, max_temp_withstand, min_humidity, min_soilmoisture)VALUES (%s,%s,%s,%s)"
